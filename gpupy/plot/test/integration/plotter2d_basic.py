...
class Plotter2dBasic():
    ...
    def flag(self,unf, *e):
        if unf != self._resizing:
            sf = 0.25
            self.plotter.plot_resolution_factor = 2 if not unf else sf
            self.plotter2.plot_resolution_factor = 2 if not unf else sf
            self.plotter3.plot_resolution_factor = 2 if not unf else sf
            self.plotter32.plot_resolution_factor = 2 if not unf else sf
            self.plotter33.plot_resolution_factor = 2 if not unf else sf
            self.plotter34.plot_resolution_factor = 2 if not unf else sf
            self.plotter4.plot_resolution_factor = 2 if not unf else sf
            self._resizing = unf
